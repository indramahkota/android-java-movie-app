...
public class SearchTvShowActivityTest {
    @Rule
    public ActivityTestRule<SearchTvShowActivity> activityRule = new ActivityTestRule<SearchTvShowActivity>(SearchTvShowActivity.class) {
        @Override
        protected Intent getActivityIntent() {
            Context targetContext = InstrumentationRegistry.getInstrumentation().getTargetContext();
            Intent result = new Intent(targetContext, SearchTvShowActivity.class);
            result.putExtra(SearchTvShowActivity.EXTRA_SEARCH_QUERY, "a");
            return result;
        }
    };
